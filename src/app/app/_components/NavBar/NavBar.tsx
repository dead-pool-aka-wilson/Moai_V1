...
export default function NavBar() {
  return (
    <nav className="flex w-full gap-12 h-[56px] bg-white items-center justify-between border-solid border-t p-[20px]">
      ...
      <div className="flex w-full flex-row items-center justify-between">
        <div>
          <a href="/moai" className="text-black">
            <Image src="/icons/chat.svg" width={24} height={24} alt="moai" />
          </a>
        </div>
